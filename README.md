...
| **15** | Building Your First RAG System (From Scratch) | Build a complete RAG pipeline from raw Python (no frameworks); understand loading, chunking, embedding, vector search, and generation; explore hybrid search, reranking, agentic RAG (ReAct), and evaluation metrics. | [Guidance](days/day15.md) \| [Notes](notes/day15_notes.md)                   |
